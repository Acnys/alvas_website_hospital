    ...
    <div className="bg-slate-50 min-h-screen py-12 px-6 lg:px-20 text-slate-800">
      <div className="max-w-6xl mx-auto space-y-16">
        ...
        <div className="text-center mb-8">
          <h1 className="text-4xl font-bold text-teal-800 mb-3 flex items-center justify-center">
        ...
        <section className="space-y-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="rounded-xl overflow-hidden shadow-lg border border-slate-200">
              ...
              <p className="p-4 text-sm text-slate-600">Advanced neonatal care at Tenkamijar.</p>
            </div>
            <div className="rounded-xl overflow-hidden shadow-lg border border-slate-200">
              <img src={nicu2} alt="Medical staff attending to a patient in the ICU" className="w-full h-48 object-cover" />
              <p className="p-4 text-sm text-slate-600">Dedicated care in our Intensive Care Unit.</p>
            </div>
            <div className="rounded-xl overflow-hidden shadow-lg border border-slate-200">
              <img src={nicu3} alt="High-tech ventilator equipment" className="w-full h-48 object-cover" />
              <p className="p-4 text-sm text-slate-600">State-of-the-art ventilator support system.</p>
            </div>
          </div>
        </section>
