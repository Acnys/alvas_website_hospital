...
const EmergencyDepartment: React.FC = () => {
  const images = [
    { src: EmergencyImg1, alt: 'Emergency Department - Image 1' },
    { src: EmergencyImg2, alt: 'Emergency Department - Image 2' },
    { src: EmergencyImg3, alt: 'Emergency Department - Image 3' },
  ];
